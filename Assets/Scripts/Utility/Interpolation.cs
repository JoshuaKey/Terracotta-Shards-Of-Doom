...
static public class Interpolation
{
    ...
    public static Vector3 BezierCurve(Vector3 p0, Vector3 p1, Vector3 p2,Vector3 p4, float t) {
        throw new System.NotImplementedException("If you need this... Yell at Josh to fix this...");
    }
	
	public static Vector3 BezierCurvePoint(Vector3 p0, Vector3 p1, float t, float heightMult) {
